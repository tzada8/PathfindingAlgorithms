...
/**
 * The following MakePreset2 class goes through the entire grid and makes a
...
public class MakePreset2 {

    /**
     * This constructor creates the second preset option of the board. This involves
     * turning all the specific locations into barriers from an available tile.
     * 
     * @param map - The grid that will be turned into Preset2.
     */
    public MakePreset2(Node[][] map) {
